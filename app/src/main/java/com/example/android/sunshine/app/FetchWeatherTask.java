...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        long id = -1;
        String queryString = WeatherContract.LocationEntry.COLUMN_CITY_NAME + " = ?";
        Cursor cursor = mContext.getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, new String[]{"_id"}, queryString, new String[]{cityName}, null);
        if (cursor.getCount() >0){
            ...
            id = ContentUris.parseId(mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, contentValues));
        }
